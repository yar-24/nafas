    ...
    <Container>
      ...
      >
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary">
            <b>Common name : </b>
            {plant['Common name'] ? plant['Common name'][0] : 'Common name'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            <b>Common name (fr.) : </b>
            {plant['Common name (fr.)']}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            <b>Categories : </b>
            {plant.Categories}
          ...
          <Typography variant="body2" color="text.secondary">
            <b>Origin : </b>
            {plant.Origin ? plant.Origin.join(' & ') : 'Plant Origin'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            <b>Climat : </b>
            {plant.Climat}
          ...
          <Typography variant="body2" color="text.secondary">
            <b>Zone : </b>
            {plant.Zone ? plant.Zone.join(' & ') : 'Plant Zone'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            <b>Growth : </b>
            {plant.Growth}
          ...
          <Typography variant="body2" color="text.secondary">
            <b>Insects : </b>
            {plant.Insects ? plant.Insects.join(' & ') : 'Plant insects'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            <b>Appeal : </b>
            {plant.Appeal}
          ...
          <Typography variant="body2" color="text.secondary">
            <b>Use : </b>
            {plant.Use ? plant.Use.join(' & ') : 'Plant Use'}
          </Typography>
        </Box>
      </Stack>
    </Container>
